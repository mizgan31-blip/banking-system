...
* The original package name 'com.example.banking-system' is invalid and this project uses 'com.example.banking_system' instead.
...
* [Liquibase Migration](https://docs.spring.io/spring-boot/3.5.9/how-to/data-initialization.html#howto.data-initialization.migration-tool.liquibase)
